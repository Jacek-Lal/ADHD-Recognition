...
ADHD_MEDIANED, CONTROL_MEDIANED = deleteMedianEEG(ADHD_DATA, CONTROL_DATA)
ADHD_FILTERED, CONTROL_FILTERED = filterEEGData(ADHD_MEDIANED, CONTROL_MEDIANED)
...
for i in range(20):
    for j in range(19):
        ...
        plt.show()
'''
plot(ADHD_MEDIANED, 5,5)
plt.show()

plot(ADHD_FILTERED, 5, 5)
plt.show()