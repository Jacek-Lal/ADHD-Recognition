...
def train_GAN(save, data_type, n_epochs=10000, n_batch=32, g_model=gen_model, d_model=dis_model, gan_model=gan_model, latent_dim=latent_dim):

    if data_type == "ADHD":
        data = readPickle("../../PICKLE_DATA/adhdImages.pkl")

    elif data_type == "CONTROL":
        data = readPickle("../../PICKLE_DATA/controlImages.pkl")
